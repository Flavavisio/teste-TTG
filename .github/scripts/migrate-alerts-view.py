...
init_anchor = 'reportsView: true, dashboardCounts: true,'
assert app.count(init_anchor) == 1, app.count(init_anchor)
app = app.replace(init_anchor, 'reportsView: true, alertsView: true, dashboardCounts: true,', 1)
...
assert app.count('reportsView: true, alertsView: true, dashboardCounts: true,') == 1
